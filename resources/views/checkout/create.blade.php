                            ...
                            <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="pekerjaan" type="text"
                                        class="form-control {{ $errors->has('pekerjaan') ? 'is_invalid' : '' }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="expired" type="date"
                                                class="form-control {{ $errors->has('expired') ? 'is_invalid' : '' }}"
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number"
                                                class="form-control {{ $errors->has('cvc') ? 'is_invalid' : '' }}"
                                ...
                                <button type="submit" name="save" class="w-100 btn btn-primary">Pay Now</button>
